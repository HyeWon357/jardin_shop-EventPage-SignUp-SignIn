					...
					<div id="contents">
						<div id="mypage">
							...
							<c:forEach var="dto" items="${event_list}">
								<div class="eventList">
									<ul>
										<li><a href="event_content?bId=${dto.bId}">
												<div class="img">
													<img src="../uploadFile/${dto.bFile}">
												</div>
												<div class="txt">
													<div class="subject">${dto.bTitle }</div>
													<div class="day">이벤트 기간 &nbsp; ${dto.bDate}&nbsp; ~
														&nbsp; ${dto.bDate2}</div>
												</div>
										</a></li>
							...
							<div class="btnAreaList">
								<div class="allPageMoving1">
									...
									<c:if test="${pagingDto2.prev}">
										<a href="event_list${pagingDto2.makeQuery(pagingDto2.startPage - 1)}" class="next"><img src="../images/btn/btn_next1.gif" alt="뒤페이지로" /> 이전</a>
									</c:if>

									<c:forEach begin="${pagingDto2.startPage}" end="${pagingDto2.endPage}" var="idx">
										<a href="event_list${pagingDto2.makeQuery(idx)}">${idx}</a>
									</c:forEach>

									<c:if test="${pagingDto2.next && pagingDto2.endPage > 0}">
										<a href="event_list${pagingDto2.makeQuery(pagingDto2.endPage + 1)}"><img src="../images/btn/btn_pre1.gif" alt="앞페이지로" />다음</a>
									</c:if>
