...
<script type="text/javascript">
	...
	//check box 확인
	function box_ch(JOIN) {
		
		var ch1 = 0;
		var ch2 = document.JOIN.agree.length;
		
		for(var i=0; i<ch2; i++) {
			if(eval("document.JOIN.agree[" + i + "].checked") == true) {
				ch1 += 1;
			}
		}
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<!-- contents -->
			<form action="join3" name="JOIN" method="post">
			<div id="contents">
				<div id="member">
					...
					<div class="agreeWrap">
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul class="fn">	
								<li class="chk">
									<input type="checkbox" id="Allch" onclick="allbox_ch()"/><label>전체동의 </label>
								</li>
							</ul>
						</div>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								...
								<li><input type="button" class="sbtnMini" onclick="box_ch(this.JOIN)" value="가입하기"></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
