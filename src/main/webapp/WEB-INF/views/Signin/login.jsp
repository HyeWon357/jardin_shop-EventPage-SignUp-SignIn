...
$(document).ready(function() {
	...
	$("#btnlogin").click(function() {
		...
		//폼 내부의 데이터를 전송할 주소
		document.login.action="../Signin/loginCh";
				...
				<div id="snbBox">
					...
					<div id="snb">
						...
						<c:otherwise>
							...
							<li><a href="../Signin/logout">로그아웃</a></li>
			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" class="loginType" name="j_id" id="j_id" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="password" class="passType" name="j_pw" id="j_pw" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>

							<div class="btn"><button type="button" id="btnlogin" class="sbtn">로그인</button></div>
